...
typedef enum {						/* Algorithms */
	...
	CRYPT_ALGO_FIRST_CONVENTIONAL = 1, /* first conventional cipher */
	CRYPT_ALGO_LAST_CONVENTIONAL = 99, /* last conventional cipher */
	CRYPT_ALGO_FIRST_PKC = 100,  /* first public key cipher */
	CRYPT_ALGO_LAST_PKC = 199,  /* last public key cipher */
	CRYPT_ALGO_FIRST_HASH = 200,  /* first hash algorithm */
	CRYPT_ALGO_LAST_HASH = 299,  /* last hash algorithm */
	CRYPT_ALGO_FIRST_MAC = 300,  /* first message authentication cipher */
	CRYPT_ALGO_LAST_MAC = 399  /* last message authentication cipher */
	} CRYPT_ALGO_TYPE;
...
typedef enum {
	...
	CRYPT_PKCFORMAT_PKCS1,			/* PKCS #1 format type */
	CRYPT_PKCFORMAT_DEFAULT = CRYPT_PKCFORMAT_PKCS1, /* default PKCS format type */
...
typedef enum {						/* Keyset types */
	...
	CRYPT_KEYSET_ODBC_STORE = CRYPT_KEYSET_DATABASE_STORE, /* ODBC certificate store */
...
typedef enum {						/* Certificate object types */
	...
	CRYPT_CERTTYPE_CRL,				/* Certificate Revocation List */
...
typedef enum {
	...
	CRYPT_FORMAT_PKCS7 = CRYPT_FORMAT_CMS, /* PKCS #7 / CMS / S/MIME fmt. */
...
typedef enum {
	...
	CRYPT_SESSION_TLS,				/* TLS */
		CRYPT_SESSION_SSL = CRYPT_SESSION_TLS, /* TLS */
	CRYPT_SESSION_TLS_SERVER,		/* TLS server */
		CRYPT_SESSION_SSL_SERVER = CRYPT_SESSION_TLS_SERVER, /* TLS server */
...
typedef enum {
	...
	/* Used internally */
	CRYPT_PROPERTY_FIRST, /* For internal use */
	...
	/* Used internally */
	CRYPT_PROPERTY_LAST, CRYPT_GENERIC_FIRST, /* For internal use */
	...
	/* Used internally */
	CRYPT_GENERIC_LAST, CRYPT_OPTION_FIRST = 100, /* For internal use */
	...
	CRYPT_OPTION_CMS_DEFAULTATTRIBUTES,	/* Add default CMS attributes */
		CRYPT_OPTION_SMIME_DEFAULTATTRIBUTES = CRYPT_OPTION_CMS_DEFAULTATTRIBUTES, /* Add default CMS attributes */
	...
	/* Used internally */
	CRYPT_OPTION_LAST, CRYPT_CTXINFO_FIRST = 1000, /* For internal use  */
	...
	/* Used internally */
	CRYPT_CTXINFO_LAST, CRYPT_CERTINFO_FIRST = 2000, /* For internal use */
	...
	CRYPT_CERTINFO_FINGERPRINT_SHA1,/* Certificate fingerprint SHA-1 */
	CRYPT_CERTINFO_FINGERPRINT_SHA2, /* Certificate fingerprint SHA-2 */
	CRYPT_CERTINFO_FINGERPRINT_SHAng, /* Next generation certificate fingerprint SHA*/
	CRYPT_CERTINFO_CURRENT_CERTIFICATE,/* Cursor management: Relative position in chain/CRL/OCSP */
	...
	CRYPT_CERTINFO_VERSION,			/* Certificate format version */
	CRYPT_CERTINFO_SERIALNUMBER,	/* Certificate serial number */
	CRYPT_CERTINFO_SUBJECTPUBLICKEYINFO,	/* Public key */
	CRYPT_CERTINFO_CERTIFICATE,		/* User certificate */
	CRYPT_CERTINFO_USERCERTIFICATE = CRYPT_CERTINFO_CERTIFICATE, /* User certificate */
	CRYPT_CERTINFO_CACERTIFICATE,	/* CA certificate */
	CRYPT_CERTINFO_ISSUERNAME,		/* Issuer DN */
	CRYPT_CERTINFO_VALIDFROM,		/* Certificate valid-from time */
	CRYPT_CERTINFO_VALIDTO,			/* Certificate valid-to time */
	CRYPT_CERTINFO_SUBJECTNAME,		/* Subject Distinguished Name */
	CRYPT_CERTINFO_ISSUERUNIQUEID,	/* Issuer unique ID */
	CRYPT_CERTINFO_SUBJECTUNIQUEID,	/* Subject unique ID */
	CRYPT_CERTINFO_CERTREQUEST,		/* Certificate Request (DN + public key) */
	CRYPT_CERTINFO_THISUPDATE,		/* CRL/OCSP current-update time */
	CRYPT_CERTINFO_NEXTUPDATE,		/* CRL/OCSP next-update time */
	CRYPT_CERTINFO_REVOCATIONDATE,	/* CRL/OCSP certificate revocation time */
	CRYPT_CERTINFO_REVOCATIONSTATUS,/* OCSP revocation status */
	CRYPT_CERTINFO_CERTSTATUS,		/* RTCS certificate status */
	CRYPT_CERTINFO_DN,				/* Currently selected Distinguished Nname in string form */
	...
	CRYPT_CERTINFO_PKIUSER_RA,		/* PKI user is an Registration Authority */
	...
	CRYPT_CERTINFO_ORGANISATIONNAME = CRYPT_CERTINFO_ORGANIZATIONNAME, /* organizationName */
	CRYPT_CERTINFO_ORGANIZATIONALUNITNAME,	/* organizationalUnitName */
	CRYPT_CERTINFO_ORGANISATIONALUNITNAME = CRYPT_CERTINFO_ORGANIZATIONALUNITNAME, /* organizationalUnitName */
	...
	CRYPT_CERTINFO_EMAIL = CRYPT_CERTINFO_RFC822NAME, /* Email address */
	...
	CRYPT_CERTINFO_URL = CRYPT_CERTINFO_UNIFORMRESOURCEIDENTIFIER, /* uniformResourceIdentifier */
	...
	CRYPT_CERTINFO_CHALLENGEPASSWORD = CRYPT_CERTINFO_FIRST + 200, /* challengePassword */

	/* 1 3 6 1 4 1 3029 3 1 4 cRLExtReason */
	CRYPT_CERTINFO_CRLEXTREASON, /* CRL Ext Reason */

	/* 1 3 6 1 4 1 3029 3 1 5 keyFeatures */
	CRYPT_CERTINFO_KEYFEATURES, /*Key Features */

	/* 1 3 6 1 5 5 7 1 1 authorityInfoAccess */
	CRYPT_CERTINFO_AUTHORITYINFOACCESS, /*authorityInfoAccess */
	...
	CRYPT_CERTINFO_BIOMETRICINFO, /* biometric Information */ 
	...
	CRYPT_CERTINFO_QCSTATEMENT, /* qcStatements */
	CRYPT_CERTINFO_QCSTATEMENT_SEMANTICS, /* qcStatement.statementInfo.semanticsIdentifier */
	CRYPT_CERTINFO_QCSTATEMENT_REGISTRATIONAUTHORITY, /* qcStatement.statementInfo.nameRegistrationAuthorities */

	/* 1 3 6 1 5 5 7 1 7 ipAddrBlocks */
	CRYPT_CERTINFO_IPADDRESSBLOCKS, /* ipAddrBlocks */
...
/*	CRYPT_CERTINFO_IPADDRESSBLOCKS_INHERIT,	// ipAddress.inherit */
	...
	CRYPT_CERTINFO_AUTONOMOUSSYSIDS, /*autonomousSysIds */
/*	CRYPT_CERTINFO_AUTONOMOUSSYSIDS_ASNUM_INHERIT,// asNum.inherit */
	...
	CRYPT_CERTINFO_OCSP_RESPONSE, /* ocspAcceptableResponses */
	CRYPT_CERTINFO_OCSP_RESPONSE_OCSP,		/* OCSP standard response */

	/* 1 3 6 1 5 5 7 48 1 5 ocspNoCheck */
	CRYPT_CERTINFO_OCSP_NOCHECK, /* OSCP NoCheck */

	/* 1 3 6 1 5 5 7 48 1 6 ocspArchiveCutoff */
	CRYPT_CERTINFO_OCSP_ARCHIVECUTOFF, /* OSCP ArchiveCutoff */

	/* 1 3 6 1 5 5 7 48 1 11 subjectInfoAccess */
	CRYPT_CERTINFO_SUBJECTINFOACCESS, /*subjectInfoAccess */
	...
	CRYPT_CERTINFO_SIGG_DATEOFCERTGEN, /* siggDateOfCertGen */

	/* 1 3 36 8 3 2 siggProcuration */
	CRYPT_CERTINFO_SIGG_PROCURATION, /* siggProcuration */
	...
	CRYPT_CERTINFO_SIGG_ADMISSIONS, /* siggAdmissions */
	...
	CRYPT_CERTINFO_SIGG_MONETARYLIMIT, /* siggMonetaryLimit */
	...
	CRYPT_CERTINFO_SIGG_DECLARATIONOFMAJORITY, /* siggDeclarationOfMajority */
	CRYPT_CERTINFO_SIGG_DECLARATIONOFMAJORITY_COUNTRY,	/* fullAgeAtCountry */

	/* 1 3 36 8 3 8 siggRestriction */
	CRYPT_CERTINFO_SIGG_RESTRICTION, /* siggRestriction */

	/* 1 3 36 8 3 13 siggCertHash */
	CRYPT_CERTINFO_SIGG_CERTHASH, /* siggCertHash */

	/* 1 3 36 8 3 15 siggAdditionalInformation */
	CRYPT_CERTINFO_SIGG_ADDITIONALINFORMATION, /* siggAdditionalInformation */

	/* 1 3 101 1 4 1 strongExtranet */
	CRYPT_CERTINFO_STRONGEXTRANET, /* strongExtranet */
	...
	CRYPT_CERTINFO_SUBJECTDIRECTORYATTRIBUTES, /* subjectDirectoryAttributes */
	...
	CRYPT_CERTINFO_SUBJECTKEYIDENTIFIER, /* subjectKeyIdentifier */

	/* 2 5 29 15 keyUsage */
	CRYPT_CERTINFO_KEYUSAGE, /* keyUsage */

	/* 2 5 29 16 privateKeyUsagePeriod */
	CRYPT_CERTINFO_PRIVATEKEYUSAGEPERIOD, /* privateKeyUsagePeriod */
	CRYPT_CERTINFO_PRIVATEKEY_NOTBEFORE,	/* notBefore */
	CRYPT_CERTINFO_PRIVATEKEY_NOTAFTER,		/* notAfter */

	/* 2 5 29 17 subjectAltName */
	CRYPT_CERTINFO_SUBJECTALTNAME, /* subjectAltName */

	/* 2 5 29 18 issuerAltName */
	CRYPT_CERTINFO_ISSUERALTNAME, /* issuerAltName */

	/* 2 5 29 19 basicConstraints */
	CRYPT_CERTINFO_BASICCONSTRAINTS, /* basicConstraints */
	CRYPT_CERTINFO_CA,						/* cA */
		CRYPT_CERTINFO_AUTHORITY = CRYPT_CERTINFO_CA, /* cA */
	CRYPT_CERTINFO_PATHLENCONSTRAINT,		/* pathLenConstraint */

	/* 2 5 29 20 cRLNumber */
	CRYPT_CERTINFO_CRLNUMBER, /* cRLNumber */

	/* 2 5 29 21 cRLReason */
	CRYPT_CERTINFO_CRLREASON, /* cRLReason */

	/* 2 5 29 23 holdInstructionCode */
	CRYPT_CERTINFO_HOLDINSTRUCTIONCODE, /* holdInstructionCode */

	/* 2 5 29 24 invalidityDate */
	CRYPT_CERTINFO_INVALIDITYDATE, /* invalidityDate */

	/* 2 5 29 27 deltaCRLIndicator */
	CRYPT_CERTINFO_DELTACRLINDICATOR, /* deltaCRLIndicator */

	/* 2 5 29 28 issuingDistributionPoint */
	CRYPT_CERTINFO_ISSUINGDISTRIBUTIONPOINT, /* issuingDistributionPoint */
	...
	CRYPT_CERTINFO_CERTIFICATEISSUER, /* certificateIssuer */

	/* 2 5 29 30 nameConstraints */
	CRYPT_CERTINFO_NAMECONSTRAINTS, /* nameConstraints */
	...
	CRYPT_CERTINFO_CRLDISTRIBUTIONPOINT, /* cRLDistributionPoint */
	...
	CRYPT_CERTINFO_CERTIFICATEPOLICIES, /* certificatePolicies */
	...
	CRYPT_CERTINFO_POLICYMAPPINGS, /* policyMappings */
	...
	CRYPT_CERTINFO_AUTHORITYKEYIDENTIFIER, /* authorityKeyIdentifier */
	...
	CRYPT_CERTINFO_POLICYCONSTRAINTS, /* policyConstraints */
	...
	CRYPT_CERTINFO_EXTKEYUSAGE, /* extKeyUsage */
	...
	CRYPT_CERTINFO_EXTKEYUSAGE_LAST = CRYPT_CERTINFO_EXTKEY_VS_SERVERGATEDCRYPTO_CA, /* serverGatedCrypto CA */

	/* 2 5 29 40 crlStreamIdentifier */
	CRYPT_CERTINFO_CRLSTREAMIDENTIFIER, /* crlStreamIdentifier */

	/* 2 5 29 46 freshestCRL */
	CRYPT_CERTINFO_FRESHESTCRL, /* freshestCRL */
	...
	CRYPT_CERTINFO_ORDEREDLIST, /* orderedList */

	/* 2 5 29 51 baseUpdateTime */
	CRYPT_CERTINFO_BASEUPDATETIME, /* baseUpdateTime */

	/* 2 5 29 53 deltaInfo */
	CRYPT_CERTINFO_DELTAINFO, /* deltaInfo */
	CRYPT_CERTINFO_DELTAINFO_LOCATION,		/* deltaLocation */
	CRYPT_CERTINFO_DELTAINFO_NEXTDELTA,		/* nextDelta */

	/* 2 5 29 54 inhibitAnyPolicy */
	CRYPT_CERTINFO_INHIBITANYPOLICY, /* inhibitAnyPolicy */

	/* 2 5 29 58 toBeRevoked */
	CRYPT_CERTINFO_TOBEREVOKED, /* toBeRevoked */
	...
	CRYPT_CERTINFO_REVOKEDGROUPS, /* revokedGroups */
	...
	CRYPT_CERTINFO_EXPIREDCERTSONCRL, /* expiredCertsOnCRL */

	/* 2 5 29 63 aaIssuingDistributionPoint */
	CRYPT_CERTINFO_AAISSUINGDISTRIBUTIONPOINT, /* aaIssuingDistributionPoint */
	...
	CRYPT_CERTINFO_SET_HASHEDROOTKEY, /* SET hashedRootKey */
	CRYPT_CERTINFO_SET_ROOTKEYTHUMBPRINT,	/* SET rootKeyThumbPrint */

	/* 2 23 42 7 1 SET certificateType */
	CRYPT_CERTINFO_SET_CERTIFICATETYPE, /* SET certificateType */

	/* 2 23 42 7 2 SET merchantData */
	CRYPT_CERTINFO_SET_MERCHANTDATA, /* SET merchantData */
	...
	CRYPT_CERTINFO_SET_CERTCARDREQUIRED, /* SET certCardRequired */

	/* 2 23 42 7 4 SET tunneling */
	CRYPT_CERTINFO_SET_TUNNELING, /* SET tunneling */
		CRYPT_CERTINFO_SET_TUNNELLING = CRYPT_CERTINFO_SET_TUNNELING,  /* Set tunneling */
	CRYPT_CERTINFO_SET_TUNNELINGFLAG,		/* tunneling flag */
		CRYPT_CERTINFO_SET_TUNNELLINGFLAG = CRYPT_CERTINFO_SET_TUNNELINGFLAG,  /* tunneling flag */
	...
	CRYPT_CERTINFO_CMS_CONTENTTYPE = CRYPT_CERTINFO_FIRST + 500, /* S/MIME contentType */

	/* 1 2 840 113549 1 9 4 messageDigest */
	CRYPT_CERTINFO_CMS_MESSAGEDIGEST, /* messageDigest */

	/* 1 2 840 113549 1 9 5 signingTime */
	CRYPT_CERTINFO_CMS_SIGNINGTIME, /* signingTime */

	/* 1 2 840 113549 1 9 6 counterSignature */
	CRYPT_CERTINFO_CMS_COUNTERSIGNATURE,	/* counterSignature */

	/* 1 2 840 113549 1 9 13 signingDescription */
	CRYPT_CERTINFO_CMS_SIGNINGDESCRIPTION, /* signingDescription */

	/* 1 2 840 113549 1 9 15 sMIMECapabilities */
	CRYPT_CERTINFO_CMS_SMIMECAPABILITIES, /* sMIMECapabilities */
	...
	CRYPT_CERTINFO_CMS_RECEIPTREQUEST, /* receiptRequest */
	...
	CRYPT_CERTINFO_CMS_SECURITYLABEL, /* CMS SecurityLabel */
	...
	CRYPT_CERTINFO_CMS_MLEXPANSIONHISTORY, /* mlExpansionHistory */
	...
	CRYPT_CERTINFO_CMS_CONTENTHINTS, /* contentHints */
	...
	CRYPT_CERTINFO_CMS_EQUIVALENTLABEL, /* equivalentLabels */
	...
	CRYPT_CERTINFO_CMS_SIGNINGCERTIFICATE, /* signingCertificate */
	...
	CRYPT_CERTINFO_CMS_SIGNINGCERTIFICATEV2, /* signingCertificateV2 */
	...
	CRYPT_CERTINFO_CMS_SIGNATUREPOLICYID, /* signaturePolicyID */
	...
	CRYPT_CERTINFO_CMS_SIGTYPEIDENTIFIER, /* signatureTypeIdentifier */
	...
	CRYPT_CERTINFO_CMS_ALGORITHMPROTECTION, /* CMS AlgorithmProtection */ 
	...
	CRYPT_CERTINFO_CMS_SPCAGENCYINFO, /* spcAgencyInfo */
	CRYPT_CERTINFO_CMS_SPCAGENCYURL,		/* spcAgencyInfo.url */

	/* 1 3 6 1 4 1 311 2 1 11 spcStatementType */
	CRYPT_CERTINFO_CMS_SPCSTATEMENTTYPE, /* spcStatementType */
	...
	CRYPT_CERTINFO_CMS_SPCOPUSINFO, /* spcOpusInfo */
	CRYPT_CERTINFO_CMS_SPCOPUSINFO_NAME,	/* spcOpusInfo.name */
	CRYPT_CERTINFO_CMS_SPCOPUSINFO_URL,		/* spcOpusInfo.url */

	/* Used internally */
	CRYPT_CERTINFO_LAST, CRYPT_KEYINFO_FIRST = 3000, /* For internal use */
	...
	/* Used internally */
	CRYPT_KEYINFO_LAST, CRYPT_DEVINFO_FIRST = 4000, /* For internal use */
	...
	CRYPT_DEVINFO_INITIALISE,	/* Initialise device for use */
		CRYPT_DEVINFO_INITIALIZE = CRYPT_DEVINFO_INITIALISE, /* Initialise device for use */
	...
	CRYPT_DEVINFO_ZEROISE,	/* Zeroise device */
		CRYPT_DEVINFO_ZEROIZE = CRYPT_DEVINFO_ZEROISE, /* Zeroise device */
	CRYPT_DEVINFO_LOGGEDIN,		/* Whether user is logged in */
	CRYPT_DEVINFO_LABEL,		/* Device/token label */

	/* Used internally */
	CRYPT_DEVINFO_LAST, CRYPT_ENVINFO_FIRST = 5000, /* For internal use */
	...
	/* Used internally */
	CRYPT_ENVINFO_LAST, CRYPT_SESSINFO_FIRST = 6000, /* For internal use */
	...
	CRYPT_SESSINFO_TLS_OPTIONS,		/* SSL/TLS protocol options */
		CRYPT_SESSINFO_SSL_OPTIONS = CRYPT_SESSINFO_TLS_OPTIONS, /* SSL/TLS protocol options */
	...
	/* Used internally */
	CRYPT_SESSINFO_LAST, CRYPT_USERINFO_FIRST = 7000, /* For internal use */
	...
	CRYPT_USERINFO_LAST, CRYPT_ATTRIBUTE_LAST = CRYPT_USERINFO_LAST /* For internal use */
...
#define CRYPT_KEYUSAGE_NONE					0x000 /* None */
#define CRYPT_KEYUSAGE_DIGITALSIGNATURE		0x001 /* Digital signature */
#define CRYPT_KEYUSAGE_NONREPUDIATION		0x002 /* Non repudiation */
#define CRYPT_KEYUSAGE_KEYENCIPHERMENT		0x004 /* Key encipherment */
#define CRYPT_KEYUSAGE_DATAENCIPHERMENT		0x008 /* Data encipherment */
#define CRYPT_KEYUSAGE_KEYAGREEMENT			0x010 /* Key agreement */
#define CRYPT_KEYUSAGE_KEYCERTSIGN			0x020 /* Key certificate signing */
#define CRYPT_KEYUSAGE_CRLSIGN				0x040 /* CRL signing */
#define CRYPT_KEYUSAGE_ENCIPHERONLY			0x080 /* Encipher only */
#define CRYPT_KEYUSAGE_DECIPHERONLY			0x100 /* Decipher only */
#define CRYPT_KEYUSAGE_LAST					0x200	/* Last possible value */
#ifdef _CRYPT_DEFINED
#define CRYPT_KEYUSAGE_FLAG_NONE			0x000	/* Defines for range checking */
#define CRYPT_KEYUSAGE_FLAG_MAX				0x1FF   /* Defines for range checking */
#endif /* _CRYPT_DEFINED */
...
#define CRYPT_CRLREASONFLAG_UNUSED				0x001 /* CRL reason: unused */
#define CRYPT_CRLREASONFLAG_KEYCOMPROMISE		0x002  /* CRL reason: Key compromise */
#define CRYPT_CRLREASONFLAG_CACOMPROMISE		0x004  /* CRL reason: CA compromise */
#define CRYPT_CRLREASONFLAG_AFFILIATIONCHANGED	0x008 /* CRL reason: Affiliation changed */
#define CRYPT_CRLREASONFLAG_SUPERSEDED			0x010 /* CRL reason: Superseded */
#define CRYPT_CRLREASONFLAG_CESSATIONOFOPERATION 0x020 /* CRL reason: Cessation of operation*/
#define CRYPT_CRLREASONFLAG_CERTIFICATEHOLD		0x040 /* CRL reason: Certificate hold */
...
#define CRYPT_NS_CERTTYPE_SSLCLIENT			0x001 /* SSL Client */
#define CRYPT_NS_CERTTYPE_SSLSERVER			0x002 /* SSL Server */
#define CRYPT_NS_CERTTYPE_SMIME				0x004 /* S/MIME */
#define CRYPT_NS_CERTTYPE_OBJECTSIGNING		0x008 /* Object signing */
#define CRYPT_NS_CERTTYPE_RESERVED			0x010 /* Reserved */
#define CRYPT_NS_CERTTYPE_SSLCA				0x020 /* SSL Certification Authority */
#define CRYPT_NS_CERTTYPE_SMIMECA			0x040 /* S/MIME Certification Authority */
#define CRYPT_NS_CERTTYPE_OBJECTSIGNINGCA	0x080 /* Object signing Certification Authority */
...
typedef enum {
	...
	CRYPT_REQUESTTYPE_INITIALISATION,	/* Initialisation request */
		CRYPT_REQUESTTYPE_INITIALIZATION = CRYPT_REQUESTTYPE_INITIALISATION, /* Initialisation request */
...
#define CRYPT_TLSOPTION_NONE				0x000  /* Min.protocol version */
#define CRYPT_TLSOPTION_MINVER_SSLV3		0x000	/* Min.protocol version */
#define CRYPT_TLSOPTION_MINVER_TLS10		0x001   /* Min.protocol version: TLS 1.0 */
#define CRYPT_TLSOPTION_MINVER_TLS11		0x002   /* Min.protocol version: TLS 1.1 */
#define CRYPT_TLSOPTION_MINVER_TLS12		0x003   /* Min.protocol version: TLS 1.2 */
#define CRYPT_TLSOPTION_MINVER_TLS13		0x004   /* Min.protocol version: TLS 1.3 */
#define CRYPT_TLSOPTION_MANUAL_CERTCHECK	0x008	/* Require manual cert.verification */
...
#define CRYPT_MAX_KEYSIZE		64 /* Maximal user key size in bytes */

/* The maximum IV/cipher block size - 256 bits */

#define CRYPT_MAX_IVSIZE		32 /* Maximal user key initialsation vector size in bytes */
...
/* The maximum public-key component size - 4096 bits, and maximum component
  ...
  #define CRYPT_MAX_PKCSIZE		CONFIG_PKC_ALLOCSIZE /* The maximum public-key component size */
#else
  #define CRYPT_MAX_PKCSIZE		512 /* The maximum public-key component size in bytes */
#endif /* CRYPT_MAX_PKCSIZE */
#define CRYPT_MAX_PKCSIZE_ECC	72    /* The maximum component size for ECCs in bytes */
...
#define CRYPT_MAX_HASHSIZE		64 /* The maximum hash size in bytes */

/* The maximum size of a text string (e.g.key owner name) */

#define CRYPT_MAX_TEXTSIZE		64 /* The maximum size of a text string (e.g.key owner name) */
...
#define CRYPT_USE_DEFAULT		( -100 )  /* A magic value indicating that the default setting for this parameter should be used. */

/* A magic value for unused parameters */

#define CRYPT_UNUSED			( -101 ) /* A magic value for unused parameters */
...
#define CRYPT_CURSOR_FIRST		( -200 ) /* Cursor positioning code for first item */
#define CRYPT_CURSOR_PREVIOUS	( -201 ) /* Cursor positioning code for previous item */
#define CRYPT_CURSOR_NEXT		( -202 ) /* Cursor positioning code for next item */
#define CRYPT_CURSOR_LAST		( -203 ) /* Cursor positioning code for last item */
...
#define CRYPT_RANDOM_FASTPOLL	( -300 ) /* fast polling to perform to get random seed information. */
#define CRYPT_RANDOM_SLOWPOLL	( -301 ) /* slow polling to perform to get random seed information. */

/* Whether the PKC key is a public or private key */

#define CRYPT_KEYTYPE_PRIVATE	0 	/* Key is a private public key cryptography key */
#define CRYPT_KEYTYPE_PUBLIC	1	/* Key is a ppublic public key cryptography key */
...
/* Results returned from the encoded object query.  These provide
   information on the objects created by cryptWrapKey()/

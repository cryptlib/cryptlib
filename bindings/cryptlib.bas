...
Public Enum CRYPT_PKCFORMAT_TYPE
...
Public Enum CRYPT_CONTENT_TYPE
 ...
 CRYPT_CONTENT_DATA
               ...
               CRYPT_CONTENT_SCVPVALPOLRESPONSE
               CRYPT_CONTENT_MRTD
               CRYPT_CONTENT_LAST
...
' CMP protocol options 
  ...
  Public Const CRYPT_CMPOPTION_NONE As Long = &H000
  Public Const CRYPT_CMPOPTION_3GPP As Long = &H001   ' Peer is following 33.310 
...
'  encountered since SSLv3 is disabled 
  ...
  Public Const CRYPT_TLSOPTION_NONE As Long = &H000
  Public Const CRYPT_TLSOPTION_MINVER_SSLV3 As Long = &H000   ' Min.protocol version 
  Public Const CRYPT_TLSOPTION_MINVER_TLS10 As Long = &H001
  Public Const CRYPT_TLSOPTION_MINVER_TLS11 As Long = &H002
  Public Const CRYPT_TLSOPTION_MINVER_TLS12 As Long = &H003
  Public Const CRYPT_TLSOPTION_MINVER_TLS13 As Long = &H004
  Public Const CRYPT_TLSOPTION_MANUAL_CERTCHECK As Long = &H008   ' Require manual cert.verif.
...
' The maximum user key size - 512 bits 
  ...
  Public Const CRYPT_MAX_KEYSIZE As Long = 64

...
/* Defines from additional headers - pcg */

#define __contract__( x )
#define __loop__( x )

#define MLK_CONFIG_CUSTOM_ZEROIZE
#define mlk_zeroize							zeroise

#define MLK_CONFIG_PARAMETER_SET			768
#if 0
  /* The namespace prefix is determined by the parameter set, we use a 
     shorter form both to avoid extremely long symbol names and to avoid
     clashes when statically linked with other modules that use the same
     code */
  ...
  #define MLK_CONFIG_FIPS202X4_CUSTOM_HEADER "fips202x4.h"
#else
  #define MLK_CONFIG_FIPS202_CUSTOM_HEADER	"crypt/fips202.h"
  #define MLK_CONFIG_FIPS202X4_CUSTOM_HEADER "crypt/fips202x4.h"
...
#if 0	/* Not needed because crypt.h handles this in a portable manner - pcg */
